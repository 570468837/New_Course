...
public interface C_Interface extends Remote{
	/**
	 * 
	 * @return 获取共享课程的xml文件
	 */
	 ...
	 */
	public boolean selectFromOtherFaculties(FileInformation file,FileInformation studentFile)throws RemoteException;

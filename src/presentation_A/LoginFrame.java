...
import A.businesslogic.StudentBL;
import A.businesslogic.UserBL;
...
public class LoginFrame extends JFrame {
	...
	StudentBLService studentBL = new StudentBL();
	/**
	 * Create the frame.
	 */
	public LoginFrame() {
		...
		loginButton.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				StudentPO student = userBL.loginValidity(userField.getText().trim(), 
